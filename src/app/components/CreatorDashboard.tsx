                ...
                >
                  ...
                  {searchResults.supporters.length > 0 && (
                    <div className="p-3 border-t border-[#e0e0e0]">
                      <h3 className="text-[10px] font-black uppercase tracking-widest text-[#999999] mb-2 px-2">Supporters</h3>
                      {searchResults.supporters.map((supporter, index) => (
                        <div key={index} className="flex items-center gap-3 p-2 hover:bg-[#f5f5f5] cursor-pointer transition-colors">
                          <div className="w-8 h-8 bg-[#f0f0f0] border border-[#e0e0e0] flex items-center justify-center text-[#111111] font-bold text-xs">{supporter.initials}</div>
                          <div className="flex-1">
                            <p className="text-[#111111] font-medium text-sm">{supporter.name}</p>
                            <p className="text-[#999999] text-xs">{supporter.username}</p>
                          </div>
                        </div>
                      ))}
                    </div>
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-[320px_1fr] gap-0 min-h-screen pt-[57px]">
        ...
        <aside className="w-full lg:sticky lg:top-[57px] lg:h-[calc(100vh-57px)] bg-[#f5f5f5] p-6 flex flex-col overflow-y-auto border-r border-[#e0e0e0]">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                <div className="w-4 h-4 bg-[#e8185d] flex items-center justify-center flex-shrink-0">
                  <Check className="w-2.5 h-2.5 text-white" />
                </div>
              </div>
              <p className="text-xs text-[#999999] uppercase tracking-wide font-bold mt-0.5">Creator</p>
            ...
            <div className="space-y-2">
              <div className="p-4 bg-white border border-[#e0e0e0]">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#999999]">Total Raised</span>
                  <TrendingUp className="w-4 h-4 text-[#e8185d]" />
                </div>
                <p className="text-2xl font-black text-[#111111]">{totalRaised}</p>
              </div>
              <div className="p-4 bg-white border border-[#e0e0e0]">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#999999]">Active Items</span>
                  <Gift className="w-4 h-4 text-[#6b6b6b]" />
                </div>
                <p className="text-2xl font-black text-[#111111]">{totalActiveItems}</p>
              </div>
              <div className="p-4 bg-white border border-[#e0e0e0]">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#999999]">Supporters</span>
                  <User className="w-4 h-4 text-[#6b6b6b]" />
                </div>
                <p className="text-2xl font-black text-[#111111]">{totalSupporters}</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-auto"
          >
            <div className="text-[10px] font-black uppercase tracking-widest text-[#999999] mb-3">Recent Supporters</div>
            <ul className="space-y-2">
              {recentSupporters.slice(0, 5).map((supporter, index) => (
                ...
                >
                  <div className="w-8 h-8 bg-[#e0e0e0] flex items-center justify-center text-[#111111] font-bold text-xs flex-shrink-0">
                    {supporter.initials}
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-[#111111] font-medium text-sm truncate">{supporter.name}</p>
                    <p className="text-[#999999] text-xs">{supporter.timeAgo}</p>
                  </div>
                  <p className="text-[#e8185d] font-black text-sm flex-shrink-0">{supporter.amount}</p>
                </motion.li>
              ))}
            </ul>
          </motion.div>
          ...
          <div className="mt-6 space-y-2">
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              onClick={onAddItem}
              className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#e8185d] hover:bg-[#c9164f] text-white font-black text-xs uppercase tracking-widest transition-colors"
            >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-2 px-6 py-3 border border-[#e0e0e0] bg-white hover:bg-[#f5f5f5] text-[#111111] font-bold text-xs uppercase tracking-wide transition-colors"
            >
              ...
              >
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-3">
                    <h2 className="text-2xl font-black text-[#111111] tracking-tight">My Wishlists</h2>
                    <span className="px-2 py-0.5 border border-[#e0e0e0] text-[#999999] text-xs font-bold">{wishlists.length}</span>
                  </div>
                  <motion.button
                    whileHover={{ scale: 1.01 }}
                    whileTap={{ scale: 0.99 }}
                    onClick={onCreateWishlist}
                    className="hidden sm:flex items-center gap-2 px-4 py-2 border border-[#e0e0e0] hover:bg-[#f5f5f5] text-[#111111] font-bold text-xs uppercase tracking-wide transition-colors"
                  >
                  ...
                  {wishlists.map((wishlist, wIndex) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-white border border-[#e0e0e0] overflow-hidden cursor-pointer group hover:shadow-md transition-shadow"
                      >
                        <div className="relative h-32 overflow-hidden bg-[#f5f5f5]">
                          {wishlist.coverImage ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center gap-3">
                              {[...Array(3)].map((_, i) => (
                                <div key={i} className="w-12 h-12 border border-[#e0e0e0] bg-white flex items-center justify-center">
                                  <Gift className="w-6 h-6 text-[#d0d0d0]" />
                                </div>
                              ))}
                            </div>
                          )}
                          <div className="absolute top-2 right-2 px-2 py-0.5 bg-white border border-[#e0e0e0] text-[10px] font-black uppercase tracking-wide text-[#6b6b6b]">
                            {wishlist.items.length} {wishlist.items.length === 1 ? "item" : "items"}
                          </div>
                        </div>

                        <div className="p-5">
                          <h3 className="text-base font-black text-[#111111] mb-1 group-hover:text-[#e8185d] transition-colors">
                            {wishlist.name}
                          </h3>
                          <p className="text-[#6b6b6b] text-xs mb-4 line-clamp-2">{wishlist.description}</p>

                          <div className="flex items-center gap-4 text-[10px] text-[#999999] mb-3 font-bold uppercase tracking-wide">
                            <span className="flex items-center gap-1">
                              <span className="w-1.5 h-1.5 rounded-full bg-[#e8185d] inline-block" />
                              {activeCount} active
                            </span>
                            <span className="flex items-center gap-1">
                            ...
                            <span className="ml-auto font-black text-[#111111]">${totalRaisedAmt.toLocaleString()}</span>
                          </div>
                          ...
                          {(() => {
                            ...
                            return (
                              <div>
                                ...
                                <p className="text-right text-[10px] text-[#999999] mt-1 font-bold">{pct}% funded</p>
                              </div>
                            );
                          })()}
                        </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-8 text-sm">
                      <button onClick={() => setSelectedWishlistId(null)} className="text-[#999999] hover:text-[#111111] transition-colors font-medium">My Wishlists</button>
                      <span className="text-[#d0d0d0]">/</span>
                      <button onClick={() => setSelectedItemIndex(null)} className="text-[#999999] hover:text-[#111111] transition-colors font-medium">{wishlist.name}</button>
                      <span className="text-[#d0d0d0]">/</span>
                      <span className="text-[#111111] font-bold truncate max-w-[200px]">{item.title}</span>
                    </div>

                    <div className="flex flex-col sm:flex-row gap-6 mb-10">
                      <div className="w-full sm:w-48 h-48 flex-shrink-0 bg-[#f5f5f5] border border-[#e0e0e0] flex items-center justify-center">
                        {item.thumbnail ? (
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2 flex-wrap">
                          <h2 className="text-3xl font-black text-[#111111] tracking-tight">{item.title}</h2>
                        ...
                        <p className="text-[#6b6b6b] mb-6 leading-relaxed text-sm">{item.description}</p>
                        <div className="p-4 bg-[#f5f5f5] border border-[#e0e0e0]">
                          <div className="flex items-center justify-between mb-3">
                            <span className="text-2xl font-black text-[#111111]">{item.raised}</span>
                            <span className="text-[#999999] text-sm">of {item.goal}</span>
                          </div>
                          ...
                          <p className="text-right text-xs text-[#999999] font-bold">{item.progress}% funded</p>
                        </div>
                      </div>
                    </div>

                    <div>
                      <div className="text-[10px] font-black uppercase tracking-widest text-[#999999] mb-4 flex items-center gap-2">
                        <span className="w-3 h-px bg-[#e8185d]" />
                        Recent Supporters
                      </div>
                      <div className="space-y-2">
                        {[
                          ...
                          <motion.div
                            ...
                            className="flex items-center gap-3 p-4 border border-[#e0e0e0] bg-white"
                          >
                            <div className="w-8 h-8 bg-[#e0e0e0] flex items-center justify-center text-[#111111] font-bold text-xs flex-shrink-0">{s.initials}</div>
                            <div className="flex-1">
                              <p className="text-[#111111] font-medium text-sm">{s.name}</p>
                              <p className="text-[#999999] text-xs">{s.timeAgo}</p>
                            </div>
                            <p className="text-[#e8185d] font-black text-sm">{s.amount}</p>
                          </motion.div>
                        ))}
                      </div>
                    </div>
              ...
              (() => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-8">
                      <div className="flex items-center gap-2 min-w-0">
                        <button
                          ...
                          className="flex items-center gap-1.5 text-[#999999] hover:text-[#111111] transition-colors text-sm font-medium flex-shrink-0"
                        >
                          <ChevronDown className="w-4 h-4 rotate-90" />
                          My Wishlists
                        </button>
                        <span className="text-[#d0d0d0]">/</span>
                        <span className="text-[#111111] font-bold text-sm truncate">{wishlist.name}</span>
                      </div>
                      <motion.button
                        whileHover={{ scale: 1.01 }}
                        whileTap={{ scale: 0.99 }}
                        onClick={onAddItem}
                        className="hidden sm:flex items-center gap-2 px-4 py-2 bg-[#e8185d] hover:bg-[#c9164f] text-white font-bold text-xs uppercase tracking-wide transition-colors"
                      >
                        <Plus className="w-3.5 h-3.5" />
                        Add Item
                      </motion.button>
                    ...
                    <div className="mb-8">
                      <h2 className="text-3xl font-black text-[#111111] mb-1 tracking-tight">{wishlist.name}</h2>
                      <p className="text-[#6b6b6b] text-sm">{wishlist.description}</p>
                    </div>
                      ...
                      {(["active", "completed", "all"] as const).map(t => (
                        <button
                          ...
                          className={`pb-4 text-sm font-bold capitalize transition-colors relative ${
                            itemTab === t ? "text-[#111111]" : "text-[#999999] hover:text-[#111111]"
                          }`}
                        >
                          {t}
                          {itemTab === t && (
                            <motion.div layoutId="itemTab" className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#e8185d]" />
                          )}
                        </button>
                      ))}
                    </div>
                    ...
                    {filteredItems.length === 0 ? (
                      <div className="py-20 text-center text-[#999999] text-sm">No {itemTab === "all" ? "" : itemTab} items in this list.</div>
                    ) : (
                      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
                        {filteredItems.map((item, index) => (
                          <motion.div
                            ...
                            className="bg-white border border-[#e0e0e0] overflow-hidden cursor-pointer group hover:shadow-md transition-shadow"
                          >
                            <div className="relative w-full h-36 flex items-center justify-center bg-[#f5f5f5]">
                            ...
                            <div className="p-4">
                              <h4 className="text-sm font-black text-[#111111] mb-1 group-hover:text-[#e8185d] transition-colors">
                                {item.title}
                              </h4>
                              <p className="text-[#999999] text-xs mb-4 line-clamp-2">{item.description}</p>
                              <div className="flex items-center justify-between mb-2">
                                <span className="text-[#111111] font-black text-sm">{item.raised}</span>
                                <span className="text-[#999999] text-xs">of {item.goal}</span>
                              </div>
                              <div className="w-full h-1 bg-[#e0e0e0] overflow-hidden">
                                <motion.div
                                  initial={{ width: 0 }}
                              ...
                              <p className="text-right text-[10px] text-[#999999] mt-1 font-bold">{item.progress}%</p>
                            </div>
                          </motion.div>
                        ))}
                      </div>
