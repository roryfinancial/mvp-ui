...
const PROJECT_1 = createProject({
  ...
  items: [
    createProjectItem({
      ...
      description: "Upgrading for better quality streams",
      goalAmount: 2500,
      raisedAmount: 1890,
      status: "active",
    }),
...
const RECENT_GIFTS: GiftEvent[] = [
  ...
  createGiftEvent({
    supporterId: "u3",
    supporterName: "Emily R.",
    itemId: "item-art",
    itemTitle: "Art Supplies Collection",
    projectId: "project-studio",
    amount: 120,
...
const FEED_CREATORS: CreatorFeedItem[] = [
  {
    id: "fc-1",
    creatorName: "Pixel Witch",
    username: "pixelwitch",
    avatarInitials: "PW",
    avatarColor: "bg-purple-600",
    itemTitle: "Pro Drawing Tablet",
    itemDescription: "Upgrading to a Wacom Cintiq for better streams",
    goalAmount: 1200,
    raisedAmount: 1080,
    gifterCount: 34,
    giftsToday: 8,
  ...
  {
    id: "fc-2",
    creatorName: "Bass Drop Benny",
    username: "bassdropbenny",
    avatarInitials: "BB",
    avatarColor: "bg-blue-600",
    itemTitle: "Studio Monitors",
    itemDescription: "KRK Rokit 8s for mixing my beats properly",
    goalAmount: 800,
    raisedAmount: 210,
    gifterCount: 12,
    giftsToday: 2,
  ...
  {
    id: "fc-3",
    creatorName: "Neon Sculptor",
    username: "neonsculptor",
    avatarInitials: "NS",
    avatarColor: "bg-pink-600",
    itemTitle: "Resin Casting Kit",
    itemDescription: "UV resin and molds for my sculpture series",
    goalAmount: 450,
    raisedAmount: 390,
    gifterCount: 28,
    giftsToday: 11,
    ...
    giftsLast24h: 11,
    tags: ["trending", "following"],
  },
  {
    id: "fc-4",
    creatorName: "Code Witch Kim",
    username: "codewitchkim",
    avatarInitials: "CK",
    avatarColor: "bg-green-600",
    itemTitle: "Mechanical Keyboard",
    itemDescription: "A proper clicky keyboard for my coding streams",
    goalAmount: 300,
    raisedAmount: 45,
    gifterCount: 5,
    giftsToday: 5,
  ...
  {
    id: "fc-5",
    creatorName: "Synth Lord",
    username: "synthlord",
    avatarInitials: "SL",
    avatarColor: "bg-orange-600",
    itemTitle: "Roland Synthesizer",
    itemDescription: "Roland JUNO-X for my ambient music project",
    goalAmount: 1800,
    raisedAmount: 540,
    gifterCount: 19,
    giftsToday: 6,
  ...
  {
    id: "fc-6",
    creatorName: "VR Dev Vance",
    username: "vrdevvance",
    avatarInitials: "VV",
    avatarColor: "bg-teal-600",
    itemTitle: "Meta Quest Pro",
    itemDescription: "Building immersive VR experiences and need the hardware",
    goalAmount: 1500,
    raisedAmount: 900,
    gifterCount: 41,
    giftsToday: 9,
...
const FEED_EVENTS: FeedEvent[] = [
  {
    ...
    type: "gift",
    actorName: "Sarah J.",
    targetName: "Pixel Witch",
    amount: 50,
    timestamp: "2026-05-02T11:45:00.000Z",
  },
  {
    id: "ev-2",
    type: "milestone",
    actorName: "Neon Sculptor",
    targetName: "Resin Casting Kit",
  ...
  },
  {
    ...
    type: "gift",
    actorName: "Emily R.",
    targetName: "VR Dev Vance",
    amount: 100,
    timestamp: "2026-05-02T10:50:00.000Z",
  },
  {
    id: "ev-5",
    type: "streak",
  ...
  },
  {
    id: "ev-6",
    type: "new_item",
    actorName: "Code Witch Kim",
    targetName: "Mechanical Keyboard",
  ...
  },
  {
    ...
    type: "gift",
    actorName: "Jordan T.",
    targetName: "Bass Drop Benny",
    amount: 25,
    timestamp: "2026-05-02T09:45:00.000Z",
  },
  {
    id: "ev-8",
    type: "gift",
    actorName: "Alex M.",
    targetName: "Synth Lord",
    amount: 75,
  ...
  },
  {
    id: "ev-9",
    type: "league_up",
    actorName: "CryptoCarlos",
    targetName: "Diamond",
    timestamp: "2026-05-02T08:55:00.000Z",
  },
  {
    id: "ev-10",
    type: "gift",
...
const _users = new Map<string, UserRecord>([
  ...
  [
    SUPPORTER.email,
    { user: SUPPORTER, passwordHash: hashPassword("demo1234") },
  ],
]);

const _projects = new Map<string, Project>([[PROJECT_1.id, PROJECT_1]]);
...
export const Store = {
  ...
  getRecommendedCreators(): CreatorFeedItem[] {
    ...
    const scored: [CreatorFeedItem, number][] = FEED_CREATORS.map((c) => {
      ...
      return [
        c,
        progress * 0.3 + velocity * 0.3 + followingBonus + recency * 0.15,
      ];
    });
  ...
  getFeedCreators(
    tab: "following" | "hot" | "explore" | "rising",
  ): CreatorFeedItem[] {
    if (tab === "following")
      return FEED_CREATORS.filter((c) => c.tags.includes("following"));
    if (tab === "hot")
      return [...FEED_CREATORS].sort((a, b) => b.giftsLast24h - a.giftsLast24h);
    if (tab === "explore") return Store.getRecommendedCreators();
    if (tab === "rising")
      return FEED_CREATORS.filter(
        (c) => c.tags.includes("rising") || c.tags.includes("new"),
      );
